    ...
    "boxes": [
      ...
      },
      {
        "box": {
          "id": "b1_azi",
          "maxclass": "newobj",
          "text": "expr (atan2($f2,$f1)+3.14159265)/6.2831853",
          "numinlets": 2,
          "numoutlets": 1,
          "outlettype": [
            "float"
      ...
      },
      {
        "box": {
          "id": "dbg_b1_title",
          "maxclass": "comment",
          "text": "DEBUG B1 input (raw + converted)",
          "patching_rect": [
            1180.0,
            30.0,
            240.0,
      ...
      },
      {
        "box": {
          "id": "dbg_b1_map_title",
          "maxclass": "comment",
          "text": "DEBUG B1 mapped lane outputs",
          "patching_rect": [
            1180.0,
            108.0,
            200.0,
