    ...
    "boxes": [
      ...
      },
      {
        "box": {
          ...
          "text": "p b1_lane_y2_core"
        }
      },
      {
        "box": {
          "id": "b1_y2_lane_clear_id0",
          "maxclass": "message",
          "numinlets": 2,
          "numoutlets": 1,
          "outlettype": [
      ...
      },
      {
        "box": {
          ...
          "text": "p b1_lane_y3_core"
        }
      },
      {
        "box": {
          "id": "b1_y3_lane_clear_id0",
          "maxclass": "message",
          "numinlets": 2,
          "numoutlets": 1,
          "outlettype": [
      ...
      {
        "box": {
          "id": "b1_multi_hide_msg",
          "maxclass": "message",
          "text": "script sendbox b1_y2_lab hidden 1, script sendbox b1_y2_ui hidden 1, script sendbox b1_y3_lab hidden 1, script sendbox b1_y3_ui hidden 1",
          "numinlets": 2,
          "numoutlets": 1,
          "outlettype": [
            ""
      ...
      {
        "box": {
          "id": "b1_multi_show_msg",
          "maxclass": "message",
          "text": "script sendbox b1_y2_lab hidden 0, script sendbox b1_y2_ui hidden 0, script sendbox b1_y3_lab hidden 0, script sendbox b1_y3_ui hidden 0",
          "numinlets": 2,
          "numoutlets": 1,
          "outlettype": [
            ""
