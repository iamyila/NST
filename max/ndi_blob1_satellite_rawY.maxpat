{
  "patcher": {
    ...
    "boxes": [
      {
        "box": {
          ...
          "text": "Blob 1: notes + X/Y/Spd/Size/Azi/Dist + map lanes (rawY)"
        }
      },
      {
        "box": {
    ...
    "devicewidth": 380.0,
    "bglocked": 1,
    "name": "ndi_blob5-8_satellite_rawY",
    "title": "ndi_blob5-8_satellite_rawY",
    "digest": "Blob 1 raw Y map bank using direct app polar data",
    "description": "Blob 1 M4L device for X/Y/Spd/Size/Azi/Dist with raw Y layout"
  }
}