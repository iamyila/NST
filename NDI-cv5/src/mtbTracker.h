...
namespace mtb{
    ...
    public:
        ...
        void update(cv::Mat & currentMat) {
            ...
            if (bUseBrightnessFill) {
                cv::Mat gray, thresh;
                cv::cvtColor(currentMat, gray, cv::COLOR_RGB2GRAY);
                cv::threshold(gray, thresh, brightnessThreshold, 255, cv::THRESH_BINARY);
...
//            }
        ...
        ofParameter<bool> bUseBrightnessFill{"Use Brightness Fill", false};
        ofParameter<int> brightnessThreshold{"Brightness Threshold", 128, 0, 255};
        ...
        ofParameterGroup bgGrp{"BG", bgAlgo, blurAmt, bUseBrightnessFill, brightnessThreshold, bgLearningRate, bDrawReferenceImage};
    };
