...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 29.0, 11.0, 49.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 29.0, 77.0, 25.0, 17.0 ],
					"text" : "6"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 29.0, 41.0, 41.0, 17.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 29.0, 111.0, 40.0, 40.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 29.0, 161.5, 50.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 27.0, 57.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 29.0, 194.268493999999919, 52.0, 17.0 ],
					"text" : "pgmout"
				}
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "testSingle.maxpat",
					"numinlets" : 0,
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 635.0, 41.0, 247.0, 176.268493999999919 ],
					"presentation" : 1,
					"presentation_rect" : [ 626.0, 35.0, 248.0, 177.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 380.0, 41.0, 247.0, 176.268493999999919 ],
					"presentation" : 1,
					"presentation_rect" : [ 369.0, 35.0, 248.0, 177.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 117.0, 41.0, 247.0, 176.268493999999919 ],
					"presentation" : 1,
					"presentation_rect" : [ 111.0, 35.0, 248.0, 177.0 ],
					"viewvisibility" : 1
				}
